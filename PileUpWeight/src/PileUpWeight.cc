...
#include "PileUpWeight/PileUpWeight/interface/PileUpWeight.h"
...
PileUpWeight::PileUpWeight(int MC, int target) { 
 ...
 {
    edm::FileInPath fip("PileUpWeight/PileUpWeight/data/pu_weights_2016.root");
 ...
 {
		edm::FileInPath fip("PileUpWeight/PileUpWeight/data/pu_weights_2017.root");
 ...
 {
		edm::FileInPath fip("PileUpWeight/PileUpWeight/data/pu_weights_2018.root");
